    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                <option value="author" @selected(old('role') === 'author')>Author — Submit articles for review</option>
                <option value="journal_editor" @selected(old('role') === 'journal_editor')>Journal Editor — Manage journals and reviews</option>
            </select>
